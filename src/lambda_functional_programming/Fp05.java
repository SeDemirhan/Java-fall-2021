...
public class Fp05 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(ortalamasıEnYuksekKursunAdiniYazdir(coursesList));
                ortalamasıEnYuksekKursunAdiniYazdir02(coursesList);
        System.out.println();
    ...
    //2.yoll
    public static void ortalamasıEnYuksekKursunAdiniYazdir02(List<Courses>list){
